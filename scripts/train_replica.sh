...
data_root_dir="/hdd24T/sunxt/dataset/few_shot_datasets/Replica"
...
for scene in ${scene_list[@]}; do
    ...
    python train/vga_trainer/trainer.py \
        --gin_file "exp_configs/Replica.gin" \
    ...
    workspace="${output_root_dir}/${exp_name}/${dataset_name}/${scene}"
    python eval/eval.py --workspace "$workspace"
    python eval/eval_mesh.py --workspace "$workspace"
